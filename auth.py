...
def tampilkan_form_auth():
    ...
    .stars-layer-2 {{
        position: fixed; inset: 0; z-index: 0; pointer-events: none;
        background-image:
            radial-gradient(1.5px 1.5px at 18% 28%, rgba(255,255,255,.6) 0%, transparent 100%),
            radial-gradient(1.5px 1.5px at 48% 14%, rgba(255,255,255,.45) 0%, transparent 100%),
            radial-gradient(1.5px 1.5px at 72% 26%, rgba(255,255,255,.55) 0%, transparent 100%),
            radial-gradient(1.5px 1.5px at 88% 48%, rgba(255,255,255,.4) 0%, transparent 100%),
            radial-gradient(1.5px 1.5px at 30% 58%, rgba(255,255,255,.5) 0%, transparent 100%),
            radial-gradient(1.5px 1.5px at 60% 72%, rgba(255,255,255,.45) 0%, transparent 100%);
    ...
    .crypto-title {{
        ...
        animation: fade-in-up .7s ease-out both, title-glow 5s ease-in-out 1s infinite;
    }}
    .crypto-sub {{
        text-align: center;
        color: #8ab4d4;
        ...
        position: relative; z-index: 10;
        animation: fade-in-up .7s ease-out .1s both;
    }}
    ...
    @keyframes title-glow {{
        ...
        50% {{ text-shadow: 0 0 18px rgba(120,170,255,.55); }}
    }}
    ...
    .st-key-auth_tab_row button:hover {{ transform: translateY(-2px) scale(1.02) !important; }}
    ...
    .st-key-auth_card .stFormSubmitButton > button:hover {{
        opacity: .92 !important;
        transform: translateY(-2px) scale(1.01) !important;
        box-shadow: 0 6px 24px #2563eb77 !important;
    }}
    </style>
    ...
    <div class="coin coin-btc" style="font-size:2.8rem;left:3%;top:38%;animation-delay:0s;animation-duration:6s">₿</div>
    <div class="coin coin-btc" style="font-size:1.6rem;left:0.5%;top:58%;animation-delay:1.2s;animation-duration:7.5s">₿</div>
    <div class="coin coin-eth" style="font-size:2.2rem;right:3%;top:42%;animation-delay:0.7s;animation-duration:5.5s">Ξ</div>
    <div class="coin coin-btc" style="font-size:1.2rem;right:0.3%;top:64%;animation-delay:2s;animation-duration:8s">₿</div>
    <div class="coin coin-eth" style="font-size:1.4rem;left:5%;top:72%;animation-delay:1.8s;animation-duration:6.8s">Ξ</div>
    <div class="coin coin-btc" style="font-size:3.2rem;right:1%;top:22%;animation-delay:0.4s;animation-duration:9s">₿</div>
